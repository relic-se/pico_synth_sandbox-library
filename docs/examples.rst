...
.. literalinclude:: ../examples/filter.py
...
.. literalinclude:: ../examples/monophonic.py
    :caption: examples/monophonic.py
    :linenos:
...
.. literalinclude:: ../examples/midi.py
    :caption: examples/midi.py
    :linenos:
...
.. literalinclude:: ../examples/drums.py
    :caption: examples/drums.py
    :linenos:
...
.. literalinclude:: ../examples/microphone.py
    :caption: examples/microphone.py
    :linenos:
...
.. literalinclude:: ../examples/microphone-fft.py
    :caption: examples/microphone-fft.py
    :linenos:
...
.. literalinclude:: ../examples/sample-simple.py
    :caption: examples/sample-simple.py
    :linenos:
...
.. literalinclude:: ../examples/sample-filter.py
    :caption: examples/sample-filter.py
    :linenos:
...
.. literalinclude:: ../examples/sample-browser.py
    :caption: examples/sample-browser.py
    :linenos:
...
.. literalinclude:: ../examples/microphone-sample.py
    :caption: examples/microphone-sample.py
    :linenos:
...
.. literalinclude:: ../examples/display-bar-horizontal.py
    :caption: examples/display-bar-horizontal.py
    :linenos:
...
.. literalinclude:: ../examples/display-bar-vertical.py
    :caption: examples/display-bar-vertical.py
    :linenos:
